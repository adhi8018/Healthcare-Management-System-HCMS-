<!-- doc.php - Registration from of doc submission-->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($conn){	
      ...
      $checkemail = "SELECT doc_email FROM doc WHERE doc_email='$mail'";
      ...
      if(mysqli_num_rows($checkemail_run)>0){
        ...
        $sql ="INSERT INTO `doc` (`doc_name`, `doc_qua`, `doc_spec`, `doc_email`, `doc_phone`, `doc_ava`, `doc_pass`) VALUES ('$name', '$qua', '$spec', '$mail', '$phone', '$ava', '$pass')";
